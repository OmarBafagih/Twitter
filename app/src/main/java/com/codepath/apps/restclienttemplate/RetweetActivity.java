...
public class RetweetActivity extends AppCompatActivity {
    ...
    public static final String TAG = "Retweet Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //unwrapping Parcel within intent
        ...
        btnTweet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(tweetContent.isEmpty()){
                    Toast.makeText(RetweetActivity.this, "Your tweet cannot be empty, try again", Toast.LENGTH_LONG).show();
                    return;
                }
                //tweet is too long
                else if(tweetContent.length() > MAX_TWEET_LENGTH){
                    Toast.makeText(RetweetActivity.this, "Your tweet is too long, try again", Toast.LENGTH_LONG).show();
                    return;
                }
                //tweet is valid, so we can make the Post request
                else{
                    twitterClient.publishRetweet(tweetContent, tweet.id, new JsonHttpResponseHandler() {
                        @Override
                        public void onSuccess(int statusCode, Headers headers, JSON json) {
                            Log.i(TAG, "Post request onSuccess");
                            setResult(RESULT_OK);
                            finish();
                            //try {
                               ...
                               /* Tweet tweet = Tweet.fromJson(json.jsonObject);
                                ...
                                //finish();
                               // Log.i(TAG, "published tweet says: ");
